...
_CHALLENGES: list[dict] = [
    ...
    {
        "text": "{player}, lass {player2} eine Nachricht von deinem Handy schreiben!",
        "category": "dare",
        "intensity": "spicy",
        "target_count": 2,
    },
    ...
    {
        "text": "Automarken-Finale: Wer als Nächstes keine Marke mehr weiß, trinkt doppelt.",
        "category": "automarken",
        "intensity": "spicy",
        "target_count": 0,
    },
    ...
    {
        "text": "Koffer packen: {player} und {player2} wiederholen die Liste gemeinsam — der erste Fehler verliert.",
        "category": "koffer packen",
        "intensity": "medium",
        "target_count": 2,
    },
    ...
    {
        "text": "Ich habe schon mal: {player} sagt etwas Mutiges. Wer es auch getan hat, trinkt einen Schluck.",
        "category": "ich habe schon mal",
        "intensity": "medium",
        "target_count": 1,
    },
    ...
    {
        "text": "Trinkregel: Immer wenn {player} lacht, müssen alle einen Schluck nehmen.",
        "category": "trinkregeln",
        "intensity": "medium",
        "target_count": 1,
    },
    ...
    def submit_feedback(self, data: ChallengeFeedbackIn) -> ChallengeFeedbackOut:
        ...
        if ft == "REPORT":
            ...
            if invalid:
                raise AppError(
                    422,
                    f"Invalid report categories: {', '.join(sorted(invalid))}. Valid: {', '.join(sorted(REPORT_CATEGORIES))}",
                    "INVALID_CATEGORY",
                )
